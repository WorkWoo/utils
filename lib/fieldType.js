...
exports.getFieldTypesArray = function () {
	var fieldTypes = [
		...
		{ displayType: 'currency', label: 'Currency', dbType: 'String' },
		...
		{ displayType: 'ListUserReference', label: 'User Dropdown (Pro only)', dbType: 'ObjectId', ref: 'users', isPro: true },
		{ displayType: 'SingleItemReference', label: 'Item (Pro only)', dbType: 'ObjectId', isPro: true },
		{ displayType: 'ListItemReference', label: 'Item Dropdown (Pro only)', dbType: 'ObjectId', isPro: true }
	];
